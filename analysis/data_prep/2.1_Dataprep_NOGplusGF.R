...
# Load data
cat("Load metaG\n")
metaG<-fread("zcat ../data/raw/OM-RGC_v2_release_profile_by_NOGplusGF_metaG.tsv.gz",sep="\t",header=T,data.table = F)
...
# Load data
cat("Load metaT\n")
metaT<-fread("zcat ../data/raw/OM-RGC_v2_release_profile_by_NOGplusGF_metaT.tsv.gz",sep="\t",header=T,data.table = F)
...
###############
cat("Save data\n")
write.table(env.mat.metaG,file="../data/processed/NOGplusGF_env.mat.metaG.txt",sep="\t",row.names=T,col.names=NA,quote=F)
write.table(env.mat.metaT,file="../data/processed/NOGplusGF_env.mat.metaT.txt",sep="\t",row.names=T,col.names=NA,quote=F)
write.table(env.mat.match,file="../data/processed/NOGplusGF_env.mat.match.txt",sep="\t",row.names=T,col.names=NA,quote=F)

write.table(metaG,file = "../data/processed/NOGplusGF_metaG.txt",sep="\t",row.names=T,col.names=NA,quote=F)
write.table(metaG.match,file = "../data/processed/NOGplusGF_metaG.match.txt",sep="\t",row.names=T,col.names=NA,quote=F)
write.table(metaG.norm,file = "../data/processed/NOGplusGF_metaG.norm.txt",sep="\t",row.names=T,col.names=NA,quote=F)
write.table(metaG.norm.match,file = "../data/processed/NOGplusGF_metaG.norm.match.txt",sep="\t",row.names=T,col.names=NA,quote=F)
write.table(metaG.norm.match.log2,file = "../data/processed/NOGplusGF_metaG.norm.match.log2.txt",sep="\t",row.names=T,col.names=NA,quote=F)

write.table(metaT,file = "../data/processed/NOGplusGF_metaT.txt",sep="\t",row.names=T,col.names=NA,quote=F)
write.table(metaT.match,file = "../data/processed/NOGplusGF_metaT.match.txt",sep="\t",row.names=T,col.names=NA,quote=F)
write.table(metaT.norm,file = "../data/processed/NOGplusGF_metaT.norm.txt",sep="\t",row.names=T,col.names=NA,quote=F)
write.table(metaT.norm.match,file = "../data/processed/NOGplusGF_metaT.norm.match.txt",sep="\t",row.names=T,col.names=NA,quote=F)
write.table(metaT.norm.match.log2,file = "../data/processed/NOGplusGF_metaT.norm.match.log2.txt",sep="\t",row.names=T,col.names=NA,quote=F)

write.table(ratio.mat,file = "../data/processed/NOGplusGF_ratio.mat.txt",sep="\t",row.names=T,col.names=NA,quote=F)
